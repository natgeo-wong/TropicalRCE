...
plot3Ddiurnal("WTG","WPW1M",plotWTG=false)
plot3Ddiurnal("WTG","DRY1M",plotWTG=false)
plot3Ddiurnal("WTG","IPW2M",plotWTG=false)
plot3Ddiurnal("WTG","WPW2M",plotWTG=false)
plot3Ddiurnal("WTG","DRY2M",plotWTG=false)
