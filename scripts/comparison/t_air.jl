...
elvl,_,ocn_DTP = prereanalysis("t_air",[15,-15,360,0])
slvl_DTP1M,tair_DTP1M = preextract("TABS","DTP1M","sst300d8")
slvl_DTP2M,tair_DTP2M = preextract("TABS","DTP2M","sst300d8")
...
_,_,ocn_IPW = prereanalysis("t_air",[15,-15,180,90])
slvl_IPW1M,tair_IPW1M = preextract("TABS","IPW1M","sst301d9")
slvl_IPW2M,tair_IPW2M = preextract("TABS","IPW2M","sst301d9")
...
_,_,ocn_WPW = prereanalysis("t_air",[5,-10,180,135])
slvl_WPW1M,tair_WPW1M = preextract("TABS","WPW1M","sst302d4")
slvl_WPW2M,tair_WPW2M = preextract("TABS","WPW2M","sst302d4")
...
_,_,ocn_DRY = prereanalysis("t_air",[5,-5,275,180])
slvl_DRY1M,tair_DRY1M = preextract("TABS","DRY1M","sst299d7")
slvl_DRY2M,tair_DRY2M = preextract("TABS","DRY2M","sst299d7")
