...
_,_,ocn_WPW = prereanalysis(evar,[5,-10,180,135]),WPW1M_3DLR = preextract(svar,"Control3D","WPW1M")
...
f.savefig(plotsdir("COMPARISON/$(evar).png"),transparent=false,dpi=200)
